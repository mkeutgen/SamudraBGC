#!/usr/bin/env python3
"""
Figure 4 v2 — Design Choice Illustrations  (Laure feedback, 2026-04)
======================================================================
...
Outputs in figures/fig04_v2/:
  fig04_v2_{suffix}.png  — full figure for each variant (see VARIANTS list)

Usage:
    python code_paper/fig04_v2.py
    sbatch code_paper/fig04_v2.sh
"""
...
OUTPUT_DIR = Path(__file__).resolve().parent / "figures" / "fig04_v2"
...
def render_variant(variant, snap_data, temp_snap_data, ts_dict, times_dt,
    ...
    out = Path(output_dir) / f"fig04_v2_{suffix}.png"
