...
#SBATCH --output=logs/phase1_velocity_nograd_eval_%j.out
#SBATCH --error=logs/phase1_velocity_nograd_eval_%j.err
...
echo "==========================================="
echo ""
echo "Config: configs/eval/phase1_velocity_nograd_eval.yaml"
...
python -m ocean_emulators.eval \
    configs/eval/phase1_velocity_nograd_eval.yaml
