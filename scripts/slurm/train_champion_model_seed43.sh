...
#SBATCH --output=logs/champion_model_seed43_train_%j.out
#SBATCH --error=logs/champion_model_seed43_train_%j.err
...
CONFIG=configs/train/champion_model_seed43.yaml

echo "Training champion_model_seed43"
echo "Config: ${CONFIG}"
