...
#SBATCH --job-name=phase5_pca10_grad010
...
#SBATCH --output=logs/phase5_pca10_helmholtz_grad010_train_%j.out
#SBATCH --error=logs/phase5_pca10_helmholtz_grad010_train_%j.err
...
CONFIG=configs/train/phase5_pca10_helmholtz_grad010.yaml

echo "Training phase5_pca10_helmholtz_grad010"
echo "Config: ${CONFIG}"
