#!/bin/bash
# Reconstruct depth-space predictions for the 50-member PCA-15 ensemble eval (2015, full BGC pert).

#SBATCH --job-name=recon_pca15_ens50
...
#SBATCH --output=logs/reconstruct_phase5_pca15_ensemble50_2015_%A_%a.out
#SBATCH --error=logs/reconstruct_phase5_pca15_ensemble50_2015_%A_%a.err
...
EVAL_ROOT=outputs/phase5_pca15_helmholtz_grad010_eval_ensemble50_2015
