...
#SBATCH --output=logs/champion_model_seed48_train_%j.out
#SBATCH --error=logs/champion_model_seed48_train_%j.err
...
CONFIG=configs/train/champion_model_seed48.yaml

echo "Training champion_model_seed48"
echo "Config: ${CONFIG}"
