...
#SBATCH --output=logs/jra_helmholtz_min_grad000_train_%j.out
#SBATCH --error=logs/jra_helmholtz_min_grad000_train_%j.err
...
echo "Config: configs/train/jra_helmholtz_min_grad000.yaml"
...
srun --ntasks=8 \
     ...
     configs/train/jra_helmholtz_min_grad000.yaml
