...
#SBATCH --output=logs/champion_model_seed52_train_%j.out
#SBATCH --error=logs/champion_model_seed52_train_%j.err
...
CONFIG=configs/train/champion_model_seed52.yaml

echo "Training champion_model_seed52"
echo "Config: ${CONFIG}"
