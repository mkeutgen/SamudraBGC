...
#SBATCH --output=logs/champion_model_seed53_train_%j.out
#SBATCH --error=logs/champion_model_seed53_train_%j.err
...
CONFIG=configs/train/champion_model_seed53.yaml

echo "Training champion_model_seed53"
echo "Config: ${CONFIG}"
