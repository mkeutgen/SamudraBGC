#!/bin/bash
# Phase 5: PCA vertical representation training (k=20) - FULL, MEMORYLESS (hist=0)
...
#SBATCH --output=logs/phase5_pca20_helmholtz_grad010_full_memoryless_train_%j.out
#SBATCH --error=logs/phase5_pca20_helmholtz_grad010_full_memoryless_train_%j.err
...
CONFIG=configs/train/phase5_pca20_helmholtz_grad010_full_memoryless.yaml

echo "Training phase5_pca20_helmholtz_grad010_full_memoryless (hist=0)"
echo "Config: ${CONFIG}"
