...
#SBATCH --output=logs/champion_model_seed49_train_%j.out
#SBATCH --error=logs/champion_model_seed49_train_%j.err
...
CONFIG=configs/train/champion_model_seed49.yaml

echo "Training champion_model_seed49"
echo "Config: ${CONFIG}"
