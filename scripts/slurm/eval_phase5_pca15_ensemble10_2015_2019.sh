...
#SBATCH --output=logs/phase5_pca15_ensemble10_2015_2019_%j.out
#SBATCH --error=logs/phase5_pca15_ensemble10_2015_2019_%j.err
...
CONFIG=configs/eval/phase5_pca15_helmholtz_grad010_eval_ensemble10_2015_2019.yaml

echo "Starting 10-member PCA-15 ensemble evaluation (test period 2015-2019)"
echo "Config: ${CONFIG}"
