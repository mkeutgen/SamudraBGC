...
#SBATCH --output=logs/jra_helmholtz_min_grad05_rollout5y_%j.out
#SBATCH --error=logs/jra_helmholtz_min_grad05_rollout5y_%j.err
...
CONFIG=configs/eval/jra_helmholtz_min_grad05_eval_rollout2010_20days.yaml
