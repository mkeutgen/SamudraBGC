...
#SBATCH --output=logs/phase7_pca15_arch_wider_deeper_resume_train_%j.out
#SBATCH --error=logs/phase7_pca15_arch_wider_deeper_resume_train_%j.err
...
CONFIG=configs/train/phase7_pca15_arch_wider_deeper_resume.yaml

echo "Resuming phase7_pca15_arch_wider_deeper [400,550,650,750] from epoch 30"
echo "Config: ${CONFIG}"
