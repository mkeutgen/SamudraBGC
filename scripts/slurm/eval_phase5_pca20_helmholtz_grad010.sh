#!/bin/bash
# Phase 5: PCA evaluation + depth-level reconstruction metrics (k=20)

#SBATCH --job-name=eval_phase5_pca20
...
#SBATCH --output=logs/eval_phase5_pca20_helmholtz_grad010_%j.out
#SBATCH --error=logs/eval_phase5_pca20_helmholtz_grad010_%j.err
...
CONFIG=configs/eval/phase5_pca20_helmholtz_grad010_eval.yaml

echo "Evaluating phase5_pca20_helmholtz_grad010"
echo "Config: ${CONFIG}"
...
EVAL_DIR=outputs/phase5_pca20_helmholtz_grad010_eval
