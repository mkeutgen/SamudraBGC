...
#SBATCH --output=logs/phase2_helmholtz_grad050_eval_%j.out
#SBATCH --error=logs/phase2_helmholtz_grad050_eval_%j.err
...
echo "Config: configs/eval/phase2_helmholtz_grad050_eval.yaml"
echo "Gradient weight: 0.50"

python -m ocean_emulators.eval \
    configs/eval/phase2_helmholtz_grad050_eval.yaml
