...
#SBATCH --output=logs/phase2_helmholtz_grad010_train_%j.out
#SBATCH --error=logs/phase2_helmholtz_grad010_train_%j.err
...
echo "Config: configs/train/phase2_helmholtz_grad010.yaml"
...
srun --ntasks=8 \
     ...
     configs/train/phase2_helmholtz_grad010.yaml
