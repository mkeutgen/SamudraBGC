#!/bin/bash
# Reconstruct depth-space predictions from PCA15 rollout output.
# Input:  outputs/phase5_pca15_helmholtz_grad010_eval_rollout2015_2019/predictions.zarr
# Output: outputs/phase5_pca15_helmholtz_grad010_eval_rollout2015_2019/predictions_depth.zarr
...
#SBATCH --mem=800G
#SBATCH --time=4:00:00
#SBATCH --output=logs/reconstruct_phase5_pca15_rollout5y_%j.out
#SBATCH --error=logs/reconstruct_phase5_pca15_rollout5y_%j.err
...
echo "Reconstructing depth-space predictions for phase5_pca15_helmholtz_grad010 rollout"
