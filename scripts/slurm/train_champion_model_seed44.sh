...
#SBATCH --output=logs/champion_model_seed44_train_%j.out
#SBATCH --error=logs/champion_model_seed44_train_%j.err
...
CONFIG=configs/train/champion_model_seed44.yaml

echo "Training champion_model_seed44"
echo "Config: ${CONFIG}"
