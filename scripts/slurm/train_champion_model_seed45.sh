...
#SBATCH --output=logs/champion_model_seed45_train_%j.out
#SBATCH --error=logs/champion_model_seed45_train_%j.err
...
CONFIG=configs/train/champion_model_seed45.yaml

echo "Training champion_model_seed45"
echo "Config: ${CONFIG}"
