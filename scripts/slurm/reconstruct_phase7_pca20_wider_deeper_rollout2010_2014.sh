#!/bin/bash
# Reconstruct depth-space predictions from phase7_pca20_arch_wider_deeper rollout (2010-2014)
...
#SBATCH --mem=800G
#SBATCH --time=4:00:00
#SBATCH --output=logs/reconstruct_phase7_pca20_wider_deeper_rollout2010_2014_%j.out
#SBATCH --error=logs/reconstruct_phase7_pca20_wider_deeper_rollout2010_2014_%j.err
...
echo "Reconstructing depth-space predictions for phase7_pca20_arch_wider_deeper rollout 2010-2014"
