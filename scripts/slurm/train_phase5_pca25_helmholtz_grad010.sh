#!/bin/bash
# Phase 5: PCA vertical representation training (k=25)
# Requires: PCA dataset created by scripts/slurm/fit_pca.sh

#SBATCH --job-name=phase5_pca25_grad010
...
#SBATCH --output=logs/phase5_pca25_helmholtz_grad010_train_%j.out
#SBATCH --error=logs/phase5_pca25_helmholtz_grad010_train_%j.err
...
CONFIG=configs/train/phase5_pca25_helmholtz_grad010.yaml

echo "Training phase5_pca25_helmholtz_grad010"
echo "Config: ${CONFIG}"
