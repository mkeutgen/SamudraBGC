#!/bin/bash
# Reconstruct depth-space predictions for the 20-member PCA-15 ensemble eval (2015-2019, half BGC pert).

#SBATCH --job-name=recon_pca15_ens20_hb_5y
...
#SBATCH --output=logs/reconstruct_phase5_pca15_ensemble20_halfbgc_2015_2019_%A_%a.out
#SBATCH --error=logs/reconstruct_phase5_pca15_ensemble20_halfbgc_2015_2019_%A_%a.err
...
EVAL_ROOT=outputs/phase5_pca15_helmholtz_grad010_eval_ensemble20_halfbgc_2015_2019
