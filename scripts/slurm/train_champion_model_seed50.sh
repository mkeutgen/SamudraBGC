...
#SBATCH --output=logs/champion_model_seed50_train_%j.out
#SBATCH --error=logs/champion_model_seed50_train_%j.err
...
CONFIG=configs/train/champion_model_seed50.yaml

echo "Training champion_model_seed50"
echo "Config: ${CONFIG}"
