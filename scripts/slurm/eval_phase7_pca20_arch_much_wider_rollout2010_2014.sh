...
#SBATCH --output=logs/eval_phase7_pca20_arch_much_wider_rollout2010_2014_%j.out
#SBATCH --error=logs/eval_phase7_pca20_arch_much_wider_rollout2010_2014_%j.err
...
echo "Starting 5-year rollout (2010-2014) for phase7_pca20_arch_much_wider"
echo "Config: ${CONFIG}"
