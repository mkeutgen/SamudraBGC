#!/bin/bash
# 5-year rollout (2015-2019) for phase5_pca15_helmholtz_grad010

#SBATCH --job-name=rollout5y_pca15
...
#SBATCH --output=logs/eval_phase5_pca15_helmholtz_grad010_rollout5y_%j.out
#SBATCH --error=logs/eval_phase5_pca15_helmholtz_grad010_rollout5y_%j.err
...
echo "Starting 5-year rollout evaluation for phase5_pca15_helmholtz_grad010"
echo "Config: ${CONFIG}"
