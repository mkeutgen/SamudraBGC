#!/bin/bash
# Phase 5: PCA vertical representation training (k=20) - FULL (train+val period)
# Champion model retrained on 1960-2014 for 70 epochs

#SBATCH --job-name=phase5_pca20_full
...
#SBATCH --output=logs/phase5_pca20_helmholtz_grad010_full_train_%j.out
#SBATCH --error=logs/phase5_pca20_helmholtz_grad010_full_train_%j.err
...
CONFIG=configs/train/phase5_pca20_helmholtz_grad010_full.yaml

echo "Training phase5_pca20_helmholtz_grad010_full"
echo "Config: ${CONFIG}"
