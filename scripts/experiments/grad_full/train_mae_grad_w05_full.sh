#!/bin/bash
#SBATCH --job-name=grad_full_mae_grad_w05_train
...
# Experiment: grad_full_mae_grad_w05
# Category: grad_full
# Domain: 360x360
...
# Training
echo "Starting training: grad_full_mae_grad_w05"
echo "Config: configs/experiments/grad_full/mae_grad_w05_full.yaml"
...
srun --ntasks=8 \
     ...
     configs/experiments/grad_full/mae_grad_w05_full.yaml
