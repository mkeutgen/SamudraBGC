...
#SBATCH --output=logs/paper_ablations/weidong_rmse_%j.out
#SBATCH --error=logs/paper_ablations/weidong_rmse_%j.err
...
echo "Config: configs/eval/paper_ablations/jra_helmholtz_min_grad05_eval_rollout2010_2019.yaml"
