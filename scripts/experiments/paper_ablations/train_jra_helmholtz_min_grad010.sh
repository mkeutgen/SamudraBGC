...
#SBATCH --output=logs/paper_ablations/jra_helmholtz_min_grad010_train_%j.out
#SBATCH --error=logs/paper_ablations/jra_helmholtz_min_grad010_train_%j.err
...
echo "Config: configs/experiments/paper_ablations/jra_helmholtz_min_grad010.yaml"
...
srun --ntasks=8 \
     ...
     configs/experiments/paper_ablations/jra_helmholtz_min_grad010.yaml
