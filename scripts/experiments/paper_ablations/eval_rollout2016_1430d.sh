...
#SBATCH --output=logs/paper_ablations/rollout2016_1430d_%j.out
#SBATCH --error=logs/paper_ablations/rollout2016_1430d_%j.err
...
echo "Config: configs/eval/paper_ablations/jra_helmholtz_min_grad05_eval_rollout2016_1430d.yaml"
echo ""

python -m ocean_emulators.eval \
    configs/eval/paper_ablations/jra_helmholtz_min_grad05_eval_rollout2016_1430d.yaml
