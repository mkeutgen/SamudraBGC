...
#SBATCH --output=logs/paper_ablations/phase2_helmholtz_grad010_eval_%j.out
#SBATCH --error=logs/paper_ablations/phase2_helmholtz_grad010_eval_%j.err
...
echo "Config: configs/eval/paper_ablations/phase2_helmholtz_grad010_eval.yaml"
echo "Gradient weight: 0.10"

python -m ocean_emulators.eval \
    configs/eval/paper_ablations/phase2_helmholtz_grad010_eval.yaml
