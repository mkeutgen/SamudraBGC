...
#SBATCH --output=logs/paper_ablations/phase1_helmholtz_nograd_eval_%j.out
#SBATCH --error=logs/paper_ablations/phase1_helmholtz_nograd_eval_%j.err
...
echo "==========================================="
echo ""
echo "Config: configs/eval/paper_ablations/phase1_helmholtz_nograd_eval.yaml"
echo "Time period: 2010-2014 (validation)"
echo "Output: outputs/phase1_helmholtz_nograd_eval/"
echo ""

python -m ocean_emulators.eval \
    configs/eval/paper_ablations/phase1_helmholtz_nograd_eval.yaml
...
echo "  Run: sbatch scripts/experiments/paper_ablations/run_phase1_vs_phase15_comparison.sh"
echo ""
