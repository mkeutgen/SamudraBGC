...
#SBATCH --output=logs/paper_ablations/phase1_fullstate_nograd_train_%j.out
#SBATCH --error=logs/paper_ablations/phase1_fullstate_nograd_train_%j.err
...
echo "Config: configs/experiments/paper_ablations/phase1_fullstate_nograd.yaml"
...
srun --ntasks=16 \
     ...
     configs/experiments/paper_ablations/phase1_fullstate_nograd.yaml
