...
#SBATCH --output=logs/paper_ablations/phase1_3way_comparison_%j.out
#SBATCH --error=logs/paper_ablations/phase1_3way_comparison_%j.err
...
python scripts/compare_rollouts.py \
    --config configs/eval/paper_ablations/phase1_ablation_3way_comparison.yaml
