...
#SBATCH --output=/scratch/cimes/maximek/INMOS/Ocean_Emulator/scripts/experiments/paper_ablations/logs/jra_helmholtz_min_grad05_rollout10y_%j.out
#SBATCH --error=/scratch/cimes/maximek/INMOS/Ocean_Emulator/scripts/experiments/paper_ablations/logs/jra_helmholtz_min_grad05_rollout10y_%j.err
...
CONFIG=configs/eval/paper_ablations/jra_helmholtz_min_grad05_eval_rollout2010_2019.yaml
