...
#SBATCH --output=logs/paper_ablations/phase15_helmholtz_log_eval_%j.out
#SBATCH --error=logs/paper_ablations/phase15_helmholtz_log_eval_%j.err
...
echo "Config: configs/eval/paper_ablations/phase15_helmholtz_log_eval.yaml"
