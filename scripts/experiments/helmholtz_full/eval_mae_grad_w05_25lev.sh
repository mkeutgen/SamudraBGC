...
#SBATCH --mem=80G
#SBATCH --output=logs/helmholtzfull_mae_grad_w05_25lev_eval_%j.out
#SBATCH --error=logs/helmholtzfull_mae_grad_w05_25lev_eval_%j.err
...
# Evaluation
echo "Starting evaluation: helmholtzfull_mae_grad_w05_25lev"
echo "Config: configs/eval/helmholtz_full/mae_grad_w05_25lev.yaml"
...
CKPT_PATH="./outputs/helmholtzfull_mae_grad_w05_25lev/saved_nets/ema_ckpt.pt"
echo "Using checkpoint: ${CKPT_PATH}"
echo "Using data from: ${DATA_PATH}"

python -m ocean_emulators.eval \
     configs/eval/helmholtz_full/mae_grad_w05_25lev.yaml \
     --ckpt_path ${CKPT_PATH} \
