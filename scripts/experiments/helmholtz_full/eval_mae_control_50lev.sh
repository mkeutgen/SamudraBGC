#!/bin/bash
#SBATCH --job-name=helmholtzfull_mae_control_50lev_eval
...
#SBATCH --mem=80G
#SBATCH --output=logs/helmholtzfull_mae_control_50lev_eval_%j.out
#SBATCH --error=logs/helmholtzfull_mae_control_50lev_eval_%j.err

# Evaluation for: helmholtzfull_mae_control_50lev
