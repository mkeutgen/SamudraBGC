#!/bin/bash
#SBATCH --job-name=jra_classical_mae_eval
...
#SBATCH --output=logs/jra_classical_mae_eval_%j.out
#SBATCH --error=logs/jra_classical_mae_eval_%j.err
