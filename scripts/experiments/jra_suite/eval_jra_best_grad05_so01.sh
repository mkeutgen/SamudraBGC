#!/bin/bash
#SBATCH --job-name=jra_best_grad05_so01_eval
...
#SBATCH --output=logs/jra_best_grad05_so01_eval_%j.out
#SBATCH --error=logs/jra_best_grad05_so01_eval_%j.err
...
# Evaluation
echo "Starting evaluation: jra_best_grad05_so01"
...
CHECKPOINT_PATH="outputs/jra_best_grad05_so01/checkpoints/checkpoint_epoch_60.pt"
