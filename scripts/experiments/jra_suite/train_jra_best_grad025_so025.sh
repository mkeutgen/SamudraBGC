#!/bin/bash
#SBATCH --job-name=jra_best_grad025_so025_train
...
#SBATCH --output=logs/jra_best_grad025_so025_train_%j.out
#SBATCH --error=logs/jra_best_grad025_so025_train_%j.err
...
# Training
echo "Starting training: jra_best_grad025_so025"
