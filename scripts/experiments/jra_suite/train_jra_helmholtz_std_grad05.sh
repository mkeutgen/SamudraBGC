#!/bin/bash
#SBATCH --job-name=jra_helmholtz_std_grad05_train
...
#SBATCH --output=logs/jra_helmholtz_std_grad05_train_%j.out
#SBATCH --error=logs/jra_helmholtz_std_grad05_train_%j.err

# Experiment: Helmholtz + Standard Forcing (Expected Winner)
# Phase: 1.2
# Suite: JRA 60-year BGC Emulator Training
# Memory-optimized: 48 CPUs/task, 150GB RAM (smaller model, matches 24 data workers)
...
# Training
echo "Starting training: jra_helmholtz_std_grad05"
