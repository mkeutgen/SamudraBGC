...
#SBATCH --output=logs/champion_model_seed51_train_%j.out
#SBATCH --error=logs/champion_model_seed51_train_%j.err
...
CONFIG=configs/train/champion_model_seed51.yaml

echo "Training champion_model_seed51"
echo "Config: ${CONFIG}"
