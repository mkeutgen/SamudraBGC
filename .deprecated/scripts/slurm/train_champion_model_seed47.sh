...
#SBATCH --output=logs/champion_model_seed47_train_%j.out
#SBATCH --error=logs/champion_model_seed47_train_%j.err
...
CONFIG=configs/train/champion_model_seed47.yaml

echo "Training champion_model_seed47"
echo "Config: ${CONFIG}"
