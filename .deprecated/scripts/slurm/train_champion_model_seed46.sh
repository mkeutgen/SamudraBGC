...
#SBATCH --output=logs/champion_model_seed46_train_%j.out
#SBATCH --error=logs/champion_model_seed46_train_%j.err
...
CONFIG=configs/train/champion_model_seed46.yaml

echo "Training champion_model_seed46"
echo "Config: ${CONFIG}"
