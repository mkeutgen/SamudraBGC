#!/bin/bash
#SBATCH --job-name=phase2_mae_dyn_g025
...
#SBATCH --output=logs/phase2_mae_dynamic_grad025_train_%j.out
#SBATCH --error=logs/phase2_mae_dynamic_grad025_train_%j.err

# Paper Ablation Study - Phase 2: MAE Dynamic Loss
# Configuration: mae_dynamic with gradient_weight = 0.25
...
echo "Training: phase2_mae_dynamic_grad025"
echo "Config: configs/train/phase2_mae_dynamic_grad025.yaml"
...
srun --ntasks=8 \
     ...
     configs/train/phase2_mae_dynamic_grad025.yaml
