#!/bin/bash
#SBATCH --job-name=phase1_fullstate_nograd_v2
...
#SBATCH --output=logs/phase1_fullstate_nograd_v2_train_%j.out
#SBATCH --error=logs/phase1_fullstate_nograd_v2_train_%j.err

# Paper Ablation Study - Phase 1: Variable Selection (v2: 8 nodes, 50 epochs)
...
# Training
echo "Starting training: phase1_fullstate_nograd (v2: 8 nodes, 50 epochs)"
