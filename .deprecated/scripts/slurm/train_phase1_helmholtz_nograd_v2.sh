#!/bin/bash
#SBATCH --job-name=phase1_helmholtz_nograd_v2
...
#SBATCH --output=logs/phase1_helmholtz_nograd_v2_train_%j.out
#SBATCH --error=logs/phase1_helmholtz_nograd_v2_train_%j.err
...
# Training
echo "Starting training: phase1_helmholtz_nograd (v2: 8 nodes, 50 epochs)"
